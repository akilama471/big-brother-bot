...
# 07/11/2010 - 0.9.4  - GrosBedo  - ban and unban messages are now more generic and can be configured from b311.xml
...
class Oa081Parser(AbstractParser):
    ...
    _eventMap = {
        ...
        # 'restartgame' : b311.events.EVT_GAME_ROUND_END
    }
            ...
            if client:
                ...
                if 'guid' in bclient:
                    ...
                    if 'skill' in bclient:
                        ...
                        self.clients.newClient(cid, name=bclient['name'], ip='0.0.0.0', state=b311.STATE_ALIVE,
                ...
                if 'ip' in bclient:
                    self.clients.newClient(cid, name=bclient['name'], ip=bclient['ip'], state=b311.STATE_ALIVE,
    ...
    def OnKill(self, action, data, match=None):
        ...
        elif attacker.team != b311.TEAM_UNKNOWN and attacker.team != b311.TEAM_FREE and attacker.team == victim.team:
    ...
    def OnCtf(self, action, data, match=None):
        ...
        if action_id == 'flag_returned':
            ...
            # return b311.events.Event(b311.events.EVT_CLIENT_ACTION, action_id, client)
