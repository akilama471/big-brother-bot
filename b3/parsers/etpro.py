...
# 14/02/2015 - 0.0.9  - Courgette - display a tip in b311.log at bot start regarding the correct use of b_privatemessages
        ...
        if bclient:
            ...
            if client:
                ...
                self.clients.newClient(bclient['cid'], name=bclient['name'], ip=bclient['ip'],
                                       state=b311.STATE_ALIVE, guid=guid, data={'guid': guid})
