...
#     """
#     To run tests : python b311/parsers/bfbc2/rcon.py <rcon_ip> <rcon_port> <rcon_password>
#     """
#     import sys
#     if len(sys.argv) != 4:
...
#         pw = sys.argv[3]
#
#     from b311.fake import fakeconsole
#
#     import b311.parsers.frostbite.connection as fbConnection
