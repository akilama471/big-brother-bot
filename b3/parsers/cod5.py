...
# 15/10/2014 - 1.4.1 - 82ndab.Bravo17 - allow minimum guid length to be set in b311 xml, guid_length in b311 section
# 19/03/2015 - 1.4.2 - Fenix          - removed unused import statemnet (from b311 import functions)
...
import b311.parsers.cod2


class Cod5Parser(b311.parsers.cod2.Cod2Parser):
    gameName = 'cod5'
    IpsOnly = False
    ...
    def pluginsStarted(self):
        ...
        if self.config.has_option('b311', 'guid_length'):
            self._guidLength = self.config.getint('b311', 'guid_length')
    ...
    def OnK(self, action, data, match=None):
        ...
        elif attacker.team != b311.TEAM_UNKNOWN and attacker.team and \
        ...
        for cid, c in plist.iteritems():
            ...
            if client:
                if client.guid and 'guid' in c and not self.IpsOnly:
                    if b311.functions.fuzzyGuidMatch(client.guid, c['guid']):
                        # player matches
