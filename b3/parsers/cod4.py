...
# 19/03/2015 - 1.5.1 - Fenix          - removed unused import statemnet (from b311 import functions)
...
class Cod4Parser(b311.parsers.cod2.Cod2Parser):
    gameName = 'cod4'
    IpsOnly = False
    ...
    def __new__(cls, *args, **kwargs):
        patch_b3_clients()
        return b311.parsers.cod2.Cod2Parser.__new__(cls)
...
def patch_b3_clients():
    ...
    b311.clients.Client.auth = cod4ClientAuthMethod
