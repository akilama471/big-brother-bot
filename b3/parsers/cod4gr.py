...
# CHANGELOG
#
# 2015/05/15 - 1.0 - Fenix - initial release
...
class Cod4grParser(b311.parsers.cod4.Cod4Parser):
    _guidLength = 10
    ...
    def __new__(cls, *args, **kwargs):
        b311.parsers.cod4.patch_b3_clients()
        return b311.parsers.cod4.Cod4Parser.__new__(cls)
