...
class Wop15Parser(AbstractParser):
    ...
    def OnDamage(self, action, data, match=None):
        ...
        elif attacker.team != b311.TEAM_UNKNOWN and attacker.team == victim.team and \
    ...
    def OnClientuserinfo(self, action, data, match=None):
        ...
        if bclient:
            ...
            if client:
                ...
                cid = bclient['cid']
                del bclient['cid']
                client = self.clients.newClient(cid, state=b311.STATE_ALIVE, bot=bot, **bclient)
    ...
    def queueEvent(self, event, expire=10):
        ...
        try:
            ...
            return b311.parser.Parser.queueEvent(self, event, expire)
