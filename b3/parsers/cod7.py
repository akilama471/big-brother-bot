...
import b311
import b311.parsers.cod5
import b311.parsers.q3a.rcon


class Cod7Rcon(b311.parsers.q3a.rcon.Rcon):
    rconsendstring = '\xff\xff\xff\xff\x00%s %s\00'
    rconreplystring = '\xff\xff\xff\xff\x01print\n'


class Cod7Parser(b311.parsers.cod5.Cod5Parser):
    gameName = 'cod7'
    IpsOnly = False
    ...
    def OnK(self, action, data, match=None):
        ...
        elif attacker.team != b311.TEAM_UNKNOWN and attacker.team and victim.team and attacker.team == victim.team:
