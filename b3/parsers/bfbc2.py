...
#                                   the b311/clients.py file. But it is better to make those changes only for BFBC2 at
#                                   the moment
...
# 2010/04/10 - 1.2.1  - Courgette - you can now specify in b311.xml what custom maximum line length you want to see in the
#                                   chat zone.
...
#                                   (while client.team follow the B3 team numbering scheme : b311.TEAM_BLUE, b311.TEAM_SPEC)
...
from b311.parsers.frostbite.abstractParser import AbstractParser
from b311.parsers.frostbite.util import PlayerInfoBlock
...
class Bfbc2Parser(AbstractParser):
    ...
    def startup(self):
        ...
        self.clients.newClient('Server', guid='Server', name='Server', hide=True,
                               pbid='Server', team=b311.TEAM_UNKNOWN, squad=SQUAD_NEUTRAL)
...
b311.clients.Client.messagebigqueueworker = frostbiteClientMessageBigQueueWorker
b311.clients.Client.messagebig = frostbiteClientMessageBigMethod
