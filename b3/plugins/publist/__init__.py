...
class PublistPlugin(b311.plugin.Plugin):
    ...
    def onStartup(self):
        ...
        try:
            ...
            self.console.setCvar('_B3', 'B3 %s' % b311.versionId)
        except Exception:
        ...
        self._cronTab = b311.cron.PluginCronTab(self, self.update, 0, rmin, rhour, '*', '*', '*')
        ...
        self._cronTab = b311.cron.OneTimeCronTab(self.update, 0, _im, '*', '*', '*', '*')
        self.console.cron + self._cronTab
    ...
    def update(self):
        ...
        version = getattr(b311, '__version__', 'unknown')
        if b311.functions.main_is_frozen():
            version_info = b311.getB3versionInfo()
