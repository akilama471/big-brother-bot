...
class FirstkillPlugin(b311.plugin.Plugin):
    _adminPlugin = None
    ...
    def onLoadConfig(self):
        ...
        """
        self._firstkill = self.getSetting('settings', 'firstkill', b311.BOOL, self._firstkill)
        self._firsttk = self.getSetting('settings', 'firsttk', b311.BOOL, self._firsttk)
        if self.console.gameName in ('iourt41', 'iourt42'):
            self._firsths = self.getSetting('settings', 'firsths', b311.BOOL, self._firsths)
