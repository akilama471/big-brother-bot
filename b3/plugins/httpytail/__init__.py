...
class HttpytailPlugin(b311.plugin.Plugin):
    ...
    def __init__(self, console, config=None):
        ...
        b311.plugin.Plugin.__init__(self, console=console, config=config)
    ...
    def onStartup(self):
        ...
        self.lgame_log = b311.getWritableFilePath(self.lgame_log)
    ...
    def update(self):
        ...
        while not self.stop_event.is_set() and self.console.working:
            ...
            try:
                ...
                # password in the b311 config (eg : http://user:password@host/path)
                ...
                # many connections (b311/delay is too short)
                ...
                if remoteSize > self._remoteFileOffset:
                    ...
                    # Adding the difference to our file (the file is cleaned at each startup by b311, in parser.py)
