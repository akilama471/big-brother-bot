...
class SpamcontrolPlugin(b311.plugin.Plugin):
    _adminPlugin = None
    ...
    def onLoadConfig(self):
        ...
        """
        self._maxSpamins = self.getSetting('settings', 'max_spamins', b311.INTEGER, self._maxSpamins,
                                           lambda x: clamp(x, minv=0))
        self._modLevel = self.getSetting('settings', 'mod_level', b311.LEVEL, self._modLevel)
        self._falloffRate = self.getSetting('settings', 'falloff_rate', b311.FLOAT, self._falloffRate)
