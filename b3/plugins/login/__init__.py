...
from b311.functions import hash_password

__author__ = 'Tim ter Laak'
__version__ = '1.4'


class LoginPlugin(b311.plugin.Plugin):
    _adminPlugin = None
    ...
    def onLoadConfig(self):
        ...
        """
        self._threshold = self.getSetting('settings', 'thresholdlevel', b311.INT, self._threshold)
        self._passwdlevel = self.getSetting('settings', 'passwdlevel', b311.INT, self._passwdlevel)
