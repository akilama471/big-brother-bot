...
class Poweradminurt42Plugin(Poweradminurt41Plugin):
    ...
    def loadRadioSpamProtection(self):
        ...
        """
        self._rsp_enable = self.getSetting('radio_spam_protection', 'enable', b311.BOOL, self._rsp_enable)
        self._rsp_mute_duration = self.getSetting('radio_spam_protection', 'mute_duration', b311.INT,
    ...
    def cmd_pacaptain(self, data, client, cmd=None):
        ...
        if sclient.team == b311.TEAM_SPEC:
        ...
        if sclient != client:
            team = "^1RED" if sclient.team == b311.TEAM_RED else "^4BLUE"
