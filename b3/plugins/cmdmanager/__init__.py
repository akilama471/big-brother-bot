...
from b311.config import XmlConfigParser
...
class CmdmanagerPlugin(b311.plugin.Plugin):
    _adminPlugin = None
    ...
    def onLoadConfig(self):
        ...
        """
        self._update_config_file = self.getSetting('settings', 'update_config_file', b311.BOOL,
    ...
    def onStartup(self):
        ...
        if 'cmdgrants' not in self.console.storage.getTables():
            sql_path_main = b311.getAbsolutePath('@b311/plugins/cmdmanager/sql')
...
def patch_admin_module(adminPlugin):
    ...
    b311.plugins.admin.Command.canUse = new_canUse
