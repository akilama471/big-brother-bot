...
class PunkbusterPlugin(b311.plugin.Plugin):
    _adminPlugin = None
    _cronTab = None
    ...
    def onStartup(self):
        ...
        if self.console.PunkBuster is None:
            self.warning('could not register commands because Punkbuster is disabled in your b311 configuration file')
            return False
    ...
    def onLoadConfig(self):
        ...
        if self._rebuildBans != '0':
            ...
            self._cronTab = b311.cron.PluginCronTab(self, self.rebuild_bans, '0', minute, hour, day, month, dow)
            self.console.cron + self._cronTab
