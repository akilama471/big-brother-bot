...
# 18/05/2015 - Fenix - make use of b311.getWritableFilePath when computing sqlite database file path
...
class SqliteStorage(DatabaseStorage):
    ...
    def connect(self):
        ...
        try:
            import sqlite3
            path = b311.getWritableFilePath(self.dsn[9:])
            ...
            if path == ':memory:' or is_new_database:
                self.console.info("Importing SQL file: %s..." % b311.getAbsolutePath("@b311/sql/sqlite/b311.sql"))
                self.queryFromFile("@b311/sql/sqlite/b311.sql")
