        ...
        if time() - self._lastConnectAttempt < self._reconnectDelay:
            ...
            try:
                ...
                if not self.getTables():
                    ...
                    try:
                        self.console.info(
                            "Missing MySQL database tables: importing SQL file: %s..." % b311.getAbsolutePath(
                                "@b311/sql/mysql/b311.sql"))
                        self.queryFromFile("@b311/sql/mysql/b311.sql")
                        ...
                        self.console.critical(
                            ...
                            (b311.getAbsolutePath("@b311/sql/mysql/b311.sql"), e))
            except Exception as e:
